## First time setup
### Grafana
* Add influxdb datasource here: `https://pinheiro-grafana.<your-tailnet>.ts.net/connections/datasources/new`
...
* Import dashboards at `https://pinheiro-grafana.<your-tailnet>.ts.net/dashboard/import`
