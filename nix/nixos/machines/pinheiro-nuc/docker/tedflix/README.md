...
* Add sonarr config using host `sonarr`, port `8989` and api key from `https://pinheiro-sonarr.<your-tailnet>.ts.net/settings/general`
* Add radarr config using host `radarr`, port `7878` and api key from `https://pinheiro-radarr.<your-tailnet>.ts.net/settings/general`
